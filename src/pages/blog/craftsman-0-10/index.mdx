...
export const blogmeta = {
  title: 'Craftsman 0.10 - .NET 5 Event Scaffolding and More!',
  description: `The new feature release for Craftsman brings event driven scaffolding to your .NET projects (and a ton more)!`,
  date: '2021-06-01 07:55:41', // Ctrl+Shift+I w/ Insert Date String plugin
  authors: [pauldevito],
  category: 'Releases',
  image,
...
but ended up going with MassTransit so I didn't force something paid into the mix and because the community was great. Honestly, I also picked it up pretty quickly which helped. 
