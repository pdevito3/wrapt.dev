...
## Db Context <FileRequirementPill padLeft={"sm"} type={"required"} />
...
> MYSQL USERS: You can still add MySql to your project manually. This is because, as of writing this, the MySql library is 
currently in pre-release for .NET 5, so you'll either want to add the prerelease or drop back to .NET Core 3.1 until it's ready.
