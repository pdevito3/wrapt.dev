...
When does this PKCE thing come into play though? Well, the PKCE part of this essentially just means that, in addition to providing client secret with your `/authorize` request that is managed between the authorization 
