...
- As v0.12+, you do not need to add a primary key property to your entities as they will automatically be inherited from the `BaseEntity`.
- Foreign keys can be set as shown in the example below, but note that:
  - Foreign keys are not added to DTOs with scaffolding and will need to be added manually
