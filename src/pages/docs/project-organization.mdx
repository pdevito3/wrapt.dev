...
the below is a good example. This comes from a [full write up on this blog](https://www.locktar.nl/programming/net-core/creating-custom-validators-with-fluentvalidation/) .
