...
| -------- | ---------------------------------------------------------------------------------------------------- |
| filepath | The filepath for the yaml or json file that lists the new entities that you want to add to your API. |

> 💡 The filepath is optional when using this command since all of the settings have safe defaults. This file is only needed
