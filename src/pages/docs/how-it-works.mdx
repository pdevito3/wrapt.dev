...
In practice, this means that we can scaffold out all of the boilerplate so you can open up your project and start adding your business logic right away.
...
## How it Works
Let's look at [an example](/docs/tutorial) to see it in action!