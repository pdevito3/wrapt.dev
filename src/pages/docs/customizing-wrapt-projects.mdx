...
For example, if you go into an Entity file, you'll notice a comment at the bottom like this `// add-on property marker - Do Not Delete This Comment`. This comment is what Craftsman will look for when adding new properties to your entity, so if it were removed,
