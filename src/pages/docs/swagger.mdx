...
| ApiContact          | No       | The primary contact for the API                                                                      | _None_                   |
| SwaggerEndpointUrl  | No       | The url to use for the swagger documentation.                                                        | /swagger/v1/swagger.json |
| SwaggerEndpointName | No       | The name to use on the main swagger documentation page.                                              | _None_                   |
| LicenseName         | No       | The name of the license on the swagger documentation.                                                | _None_                   |
| LicenseUrl          | No       | The url of the license on the swagger documentation.                                                 | _None_                   |
