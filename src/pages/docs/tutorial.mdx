...
### Using Your API 
Now you can `cd` into your bounded context directory and run `dotnet run --project {ProjectName}.webapi` and your API is up and all the boilerplate taken care of 🥳
