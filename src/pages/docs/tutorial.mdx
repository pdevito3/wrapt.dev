...
### Using Your API 
Now you can `cd` into your bounded context directory and run `dotnet run --project {SolutionName}.webapi` and your API is up and running with no boilerplate in sight 🥳
