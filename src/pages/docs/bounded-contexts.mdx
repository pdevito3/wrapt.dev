...
| ----------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| SolutionName                                          | Yes      | A simple string that will become the name of your solution within a bounded context.                                                                                       | _None_  |
...
| [AuthorizationSettings](/docs/authorization-settings) | No       | The authorization settings assigned to this project.                                                                                                                       | _None_  |
