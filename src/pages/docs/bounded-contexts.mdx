...
| UseCustomErrorHandler                | No       | A boolean that dictates the type of error handler middleware. By default, the `Hellang` package will be used for robustness, but if you want to reduce a dependncy and do custom error handling by setting this to `true`                                                           | _false_  |
