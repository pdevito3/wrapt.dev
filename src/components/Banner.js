            ...
            <div className="max-w-7xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between flex-wrap">
                <div className="flex-1 flex items-center justify-center md:justify-start sm:w-0">
                  ...
                  <p className="ml-3 font-medium text-white truncate block sm:hidden">
                    Support Wrapt.
                  </p>
                  <p className="ml-3 font-medium text-white truncate hidden sm:inline">
                    Support the ongoing development of Wrapt.
                  </p>
                </div>
                <div className="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto pt-2 sm:pt-0">
                  <a
